...
export const keepAliveConfig = {
	...
	allowInsertionAndDeletion: false, // Set this to false unless you're using a 'keep-alive'-dedicated table
	...
	otherEndpoints: ["https://buzz-hive-rosy.vercel.app/api/health"],
};
