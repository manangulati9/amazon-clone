...
export default function AuthorizeSeller({ email, href }: VerifyEmailProps) {
	return (
		<Html>
			<Head />
			<Preview>Seller authorization</Preview>
			<Body style={main}>
				<Container style={container}>
					<Section style={coverSection}>
						...
						<Section style={upperSection}>
							<Heading style={h1}>
								Someone requested to create a seller account on your website
							</Heading>
							<Section>
								<Text style={mainText}>Email - {email}</Text>
								<Text style={mainText}>
									To authorize this request, please click the following link -
								</Text>
							</Section>
